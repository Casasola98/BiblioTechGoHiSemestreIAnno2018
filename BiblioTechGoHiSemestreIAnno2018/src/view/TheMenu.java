...
public class TheMenu extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(! theSystem.fieldIsEmpty(thePassword)){ //Chequea si el espacio para la contrasenna se encuentra vacio
            if(theSystem.isCorrectPassword(thePassword)){ //Chequea si la contrasenna ingresada es correcta
