...
public class AddStuW extends javax.swing.JDialog {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        String career = "";
        int careerN = cmbCareer.getSelectedIndex(); //obtiene el index del tipo de carrera elegido
        ...
        if((! theSystem.fieldIsEmpty(id))&&(! theSystem.fieldIsEmpty(name))){ //revisa si las casillas se encuentran llenas
            if(theSystem.isNumber(id)){ //chequea si el id escrito en el textField esta formado de solo numeros
                if(! theSystem.existStudent(career + id)){ //chequea si el id junto a la letra inicial pertenece a un estudiante ya registrado
